...
enso_ts_reps <- read.csv(file="C:/Users/Mikaela/Documents/GitHub/pfmc/parms_data/simulated_MEI.csv",
                         header=TRUE)
ensonoise <- 
...
```{r echo=FALSE, fig.width=5, fig.height=8,warning=FALSE}
tiff(file='C:/Users/Mikaela/Documents/GitHub/pfmc/results/timeseries_v3.tiff', units="in", width=8, height=13, res=300) 
