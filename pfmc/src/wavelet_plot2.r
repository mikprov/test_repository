...
plot_gen_freq_wvlt <- function(burn_in_pd = rm_first_timesteps, #remove from beginning of ts
  ...
  tiff(file=paste('C:/Users/Mikaela/Documents/GitHub/pfmc/results/wavelet_plots/1_wvlet_A_CVnotstdz_AUC1_',noisename,'.tiff',sep=""), 
  ...
  # --------
  tiff(file=paste('C:/Users/Mikaela/Documents/GitHub/pfmc/results/wavelet_plots/1_wvlet_B_CVnotstdz_AUC1_',noisename,'.tiff',sep=""), 
       units="in", width=8, height=11, res=300) 
  par(mfrow=c(7,4),mai=c(0.2,0.3,0.2,0.2))
